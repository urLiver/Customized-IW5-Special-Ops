...
_id_3C63()
{
    ...
    if ( getdvarint( "survival_chaos" ) == 1 )
        self._id_3FC9._id_3FCA = -20 + level.perk_offset;
    else
        self._id_3FC9._id_3FCA = -34;

    if ( issplitscreen() )
        self._id_3FC9._id_3FCB = 112 + ( self == level.player ) * 27;
    else
        self._id_3FC9._id_3FCB = 210;
...
_id_3FCD()
{
    ...
    self._id_3FCE._id_3FCA = 34;

    if ( issplitscreen() )
        self._id_3FCE._id_3FCB = 112 + ( self == level.player ) * 27;
    else
        self._id_3FCE._id_3FCB = 210;
