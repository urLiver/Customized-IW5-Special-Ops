...
_id_3EBB()
{
    ...
    for ( var_0 = 0; var_0 <= level.max_weapons; var_0++ )
    {
        var_1 = _id_3D36( var_0 );

        if ( isdefined( var_1 ) && var_1 != "" && var_1 != "ammo" || var_1 != "partial_ammo" && _id_3EEF( var_1 ) == "weapon" )
    ...
    level._id_3D68 = [];
    level._id_189A = [];
    _id_3EBF( 0, level.max_weapons, "weapon" );
...
_id_3EBF( var_0, var_1, var_2 )
{
    for ( var_3 = var_0; var_3 <= var_1; var_3++ )
    {
        ...
        if ( var_2 == "weapon" && var_4 != "ammo" && var_4 != "partial_ammo" )
        {
            var_5._id_3EC5 = 1;
...
_id_3ECE()
{
    ...
    var_0.alpha = 0.75;
    var_0 setshader( self.icon, 6, 6 );
    var_0 setwaypoint( 1, 0, 0 );
    self._id_3BCC = var_0;
        ...
        if ( issubstr( var_2, "purchase" ) )
        {
            ...
            if ( self._id_3ED7 >= var_16 )
            {
                if ( _id_3EF9( var_15 ) )
                {
                    self notify( "armory_opened", var_0 );
                    _id_3EFA( var_15 );
                    self PlaySound( "so_ingame_summary" );
...
_id_3EFB( var_0, var_1 )
{
    ...
    if ( var_0 == "weapon" )
    {
        if ( var_1 == "ammo" )
            var_2 = ::_id_3EFF;
        else if( var_1 == "partial_ammo" )
            var_2 = ::partial_ammo_check;
        else
            var_2 = ::_id_3F02;
    }
...
_id_3EFC( var_0, var_1 )
{
    ...
    if ( var_0 == "weapon" )
    {
        if ( var_1 == "ammo" || var_1 == "partial_ammo" )
            var_2 = ::_id_3F00;
        else
            var_2 = ::_id_3F03;
    }
...
_id_3EFF( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        if ( weaponclass( var_3 ) == "item" || weaponclass( var_3 ) == "none" )
            continue;
...
partial_ammo_check( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( self getweaponammoclip( var_3 ) < weaponclipsize( var_3 ) || self getweaponammostock( var_3 ) < int( weaponmaxammo( var_3 ) / 2 ) )
            return 1;

        var_4 = weaponaltweaponname( var_3 );

        if ( var_4 != "none" && self getweaponammoclip( var_4 ) < weaponclipsize( var_4 ) || self getweaponammostock( var_4 ) < int( weaponmaxammo( var_3 ) / 2 ) )
            return 1;
    }
...
_id_3F01( type, var_0 )
{
    ...
    else
    {
        ...
        if( self GetWeaponAmmoStock( var_0 ) < int( weaponmaxammo( var_0 ) / 2 ) )
        {
            self setweaponammostock( var_0, int( weaponmaxammo( var_0 ) / 2 ) );
        }
        ...
        {
            self setweaponammoclip( var_1, weaponclipsize( var_1 ) );
            if( self GetWeaponAmmoStock( var_1 ) < int( weaponmaxammo( var_1 ) / 2 ) )
            {
                self setweaponammostock( var_1, int( weaponmaxammo( var_1 ) / 2 ) );
            }
        }        
    }
}
...
_id_3F15( var_0 )
{
    ...
    if ( var_0 == "light_armor" )
        var_1 = 100;

    else if ( var_0 == "armor" )
        var_1 = 250;

    else if ( var_0 == "heavy_armor" )
        var_1 = 500;
